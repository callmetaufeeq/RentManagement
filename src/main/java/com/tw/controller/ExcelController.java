  ...
  import com.tw.download.RentExcelExporter; import com.tw.dto.RentListDto;
  ...
  @RequestMapping("/excel") public class ExcelController {
  
  @Autowired private RentService rentService;
  
  @GetMapping("/rent") public void exportIntoExcelFile(HttpServletResponse
  ...
  "attachment; filename=Rent" + currentDateTime + ".xlsx";
